...
execute if score #start_cutscene timer matches 278 if entity @a[tag=language.chinese] run bossbar set minecraft:quests name [{"text": "\uA016", "color": "#feffff","font":"minecraft:default","shadow_color":[0,0,0,0]},{"translate": "space.8","font":"space"},{"text": "", "color": "#feffff"}]
