...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"这是个电视遥控器，很明显电视和遥控器都趴窝了。",total_symbols:24,time:1,state:2,next_dialogue:none,db_visual:1}
