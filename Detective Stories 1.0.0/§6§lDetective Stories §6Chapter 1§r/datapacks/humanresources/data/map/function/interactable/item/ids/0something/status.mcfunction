...
# Функция задержки
tag @s add cooldown
schedule function map:interactable/item/ids/0something/cooldown 10t
...
execute if entity @s[tag=!nah,nbt={interaction:{}}] run function map:interactable/item/ids/0something/pickup

# Если предмет можно поднять, и игрок нажал лкм, то предмет будет положен обратно
execute if entity @s[nbt={attack:{}}] run function map:interactable/item/ids/0something/remove
...
execute if score @s interactableStatus matches 1 run function map:interactable/item/ids/0something/show
execute if score @s interactableStatus matches 2 run function map:interactable/item/ids/0something/remove
