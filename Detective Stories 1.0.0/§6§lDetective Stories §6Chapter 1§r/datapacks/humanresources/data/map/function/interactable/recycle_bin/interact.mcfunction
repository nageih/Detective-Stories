...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"这个垃圾桶是空的。",total_symbols:9,time:1,state:1,next_dialogue:none,db_visual:1}
