...
execute as @e[tag=aj.main_menu.root] run function animated_java:main_menu/animations/main_chapter_pressed/play
...
execute as @e[tag=aj.main_menu.root] run function animated_java:main_menu/animations/chapter_appear/play
# Звук нажатия
...
scoreboard players set #menu_state menu 1