...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"酒保？他五分钟之前走了，走之前跟我们说他要去后厨处理点事。说不定他在准备什么，但是很奇怪啊，毕竟都这么晚了……",total_symbols:55,time:1,state:4,next_dialogue:"dialogue/choice_appear",db_visual:3}
