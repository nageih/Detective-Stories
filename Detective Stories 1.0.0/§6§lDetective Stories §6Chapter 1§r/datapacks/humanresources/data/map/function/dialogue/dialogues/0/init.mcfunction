...
execute if entity @a[tag=language.english] run function map:dialogue/init_text {text:"今天我感觉有点不对劲……是，我从大清早就开始开车送东西，之后停车找了个地方歇歇脚。目前为止我还没见到酒保，而且路上空无一物……真的，我感觉哪哪都不对劲。",total_symbols:76,time:1,state:4,next_dialogue:"dialogue/choice_appear",db_visual:2}
