...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"我才不要做这那那这的信息交换，我直说好了：我在送东西，剩余的消息我无可奉告。",total_symbols:38,time:2,state:2,next_dialogue:none,db_visual:2}
