...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"你也被困在这里了吗？这场暴风雪下的根本毫无由头……",total_symbols:25,time:1,state:2,next_dialogue:"dialogue/choice_appear",db_visual:3}
