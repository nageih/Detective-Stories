...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"这算是某种谜语吗？难道我还要猜密码？而且它指的“钟”又是什么意思？而且这行“我所见之物即为你前行之路”……？看来我必须得弄清楚这到底是怎么一回事了……",total_symbols:75,time:1,state:4,next_dialogue:none,db_visual:1}
