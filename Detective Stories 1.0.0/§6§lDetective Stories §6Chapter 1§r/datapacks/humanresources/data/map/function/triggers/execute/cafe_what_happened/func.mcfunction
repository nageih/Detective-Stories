...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"那到底是啥？！那声惨叫声是谁发出来的？！而，而且到底是谁在监视我？我……我的的确确看到了，我得把这块地方好好检查一下！",total_symbols:60,time:1,state:3,next_dialogue:none,db_visual:1}
