...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"这扇门是开着的，但是路被箱子堵死了。我试试把它们搬一边去。",total_symbols:29,time:1,state:3,next_dialogue:none,db_visual:1}
