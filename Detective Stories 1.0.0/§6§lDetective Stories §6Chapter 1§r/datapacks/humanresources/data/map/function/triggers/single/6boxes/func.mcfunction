...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"门虽然开着，但是这里头被箱子堵死了。我看看能不能把它们搬一边去。",total_symbols:32,time:1,state:3,next_dialogue:none,db_visual:1}
