...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"看见……看见什么？这些谜语到底是啥玩意啊？这儿到底怎么了？！我一点线索也没有……也许这个咖啡厅中就有我所需要的线索，我到处逛逛好了。",total_symbols:66,time:1,state:4,next_dialogue:none,db_visual:1}
