...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"怎么回事？！我……我到底怎么了？我得赶快回咖啡厅才行！",total_symbols:27,time:1,state:2,next_dialogue:none,db_visual:1}
