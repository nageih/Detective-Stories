...
execute if entity @a[tag=language.chinese] run function map:dialogue/init_text {text:"现在看来一切都回归正常了……但那个“东西”到底是什么？而且这把钥匙是干什么的？我必须得搞清楚……就以钥匙为切入点开始调查吧。",total_symbols:62,time:1,state:3,next_dialogue:none,db_visual:1}
